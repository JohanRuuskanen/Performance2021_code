function demandEst = main_MLPS(data, initSample, sampleSize, V)
% MAIN_MLPS setups the input data for the MLPS estimation method and calls it
%
...
demandEst = des_MLPS(rtExp,classExp,qlExp,lambda, V);
